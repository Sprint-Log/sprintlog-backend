...
This is a reference application that you can use to get your next Litestar application running quickly. This repository is based on the [litestarfullstack](https://github.com/litestar-org/litestar-fullstack) while removing the frontend related part.
